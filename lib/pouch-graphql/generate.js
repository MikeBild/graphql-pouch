      ...
      switch(field.kind) {
        ...
        case 'FieldDefinition':
          ...
          fields[field.name.value] = {
            ...
            //       const currentOutputType = getOutputType(field.type);
            ...
            //       const currentTypeNames = currentOutputType._interfaces ? currentOutputType._interfaces.map(x => x.name).concat([resolvedTypeName]) : [resolvedTypeName];
            //       return implementations[typeName][field.name.value](parent, args, ctx, info, currentTypeNames.concat(['Node']));
            //     }
            //   : undefined
          };
